...
class Pastille_old extends StatefulWidget {
  Pastille_old(
      {super.key,
      required this.color,
  ...
  @override
  State<Pastille_old> createState() => _Pastille_oldState();
}

class _Pastille_oldState extends State<Pastille_old> {
  ...
  @override
  void didUpdateWidget(covariant Pastille_old oldWidget) {
